...
const QuotesTable = () => {
  ...
  const { data, isLoading, isError, error, refetch } = useQuotes(page, limit);
    ...
    <div className="w-full max-w-7xl mx-auto p-2 sm:p-4 md:p-6 bg-white rounded-lg shadow-lg">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
          ...
          <button className="w-full sm:w-auto bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition">
            Tambah Quotes
          </button>
        </div>
      </div>
      ...
      <div className="flex justify-between items-center mt-4">
        <button
          ...
          className="px-4 py-2 text-sm text-gray-600 bg-white border rounded-md hover:bg-gray-100 disabled:opacity-50"
          disabled={page === 1}
        >
          Previous
        </button>
